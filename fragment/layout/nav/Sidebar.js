                ...
                <ul className="space-y-2 font-medium">
                    {sidebarItems?.map((item, index)=>(
                        <li key={index}>
                            <Link href={item.link}>
                            <a
                                className={`flex items-center p-2  text-dark rounded-lg no-underline hover:bg-primary-800 dark:hover:bg-primary-100 transition-all duration-300 hover:text-white ${
                                    selectedIndex === index && 'bg-primary-primary text-white'
                                } `}
