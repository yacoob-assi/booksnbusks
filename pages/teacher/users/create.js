...
const CreateUser = () => {
    ...
    return (
        <>
           <h4 className="font-22 font-semibold"><FiArrowLeft className="mr-2 inline-block" role="button" onClick={() => router.back()}/> Create User</h4>
            <hr className="bg-C4"/>
            <UserForm func={addUser}/>
        </>
    )
}
CreateUser.layout = TeacherLayout
