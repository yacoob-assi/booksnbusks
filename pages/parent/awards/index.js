...
const Points = () => {
    ...
    const [awards, getAwards] = useFetch(fetchAwards, {size: 5, student: student._id})
    const [summery] = useFetch(fetchWeeklySummery, {date: moment().startOf('week').toISOString(), student: student._id})
